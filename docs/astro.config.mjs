...
export default defineConfig({
	...
	integrations: [
		...
		starlight({
			...
			editLink: {
				baseUrl: "https://github.com/Mr-Freeman-UA/remnawave-reverse-proxy/edit/main/docs/",
			},
			social: [
				{ icon: 'github', label: 'GitHub', href: 'https://github.com/Mr-Freeman-UA/remnawave-reverse-proxy/' },
