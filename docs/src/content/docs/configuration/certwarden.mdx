...
6. Login to the system using the login admin and password password
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/certwarden/certwarden_login.png" 
...
7. We will be redirected to the main page
    ...
    ![Cert Warden dashboard](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/certwarden/certwarden_dashboard.png)
...
5. In the `API Access Method` field, select `API Token`. Instructions for creating a token with `Zone:Edit` permissions can be found in the [official Cloudflare documentation](https://developers.cloudflare.com/fundamentals/api/get-started/create-token/)
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/certwarden/certwarden_new_challenge_provider.png" 
...
7. A new window will pop up with our Private Key, also click on the Submit button
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/certwarden/certwarden_private_key.png" 
...
9. A window with account data will pop up
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/certwarden/certwarden_acme_accounts.png" 
...
7. Click on the Submit button
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/certwarden/certwarden_certificates.png" 
...
8. A window with ACME Orders will pop up
      ...
      ![Cert Warden ACME Orders](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/certwarden/certwarden_acme_orders.png)
...
11. Go to the `Dashboard` section and see that the certificate is received and how many days are left until the expiration date
      ...
      ![Cert Warden Dashboard](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/certwarden/certwarden_dashboard_certificate.png) 
...
2. `CW_CLIENT_AES_KEY_BASE64` - Specify the key generated in the `Certificates` -> `Post Processing` -> `Client AES Key` section. Click the `GENERATE` button to obtain the key.
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/certwarden/certwarden_aes_key.png" 
...
2. In the Cloudflare control panel for your domain certwarden.yourdomain.com, specify the IP address of the Cert Warden server in the Netbird network
      ...
      ![Cert Warden Cloudflare](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/certwarden/certwarden_ip_netbird.png) 
