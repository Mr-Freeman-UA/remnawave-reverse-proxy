...
2. Create an account.
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/netbird/register.png" 
...
5. After this, you will be taken to the Netbird Dashboard.
    ...
    ![Netbird peer](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/netbird/peer.png)
...
1. Go to the Setup Keys section. Click the Create Setup Key button.
    ...
    ![Netbird setup key](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/netbird/setup_key.png)

2. Create the key.

    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/netbird/create_new_setup_key.png" 
...
Copy the key and save it in a safe place for future use.
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/netbird/key.png" 
        alt="Netbird key" 
        style={{ maxWidth: '60%' }} 
      />
    </div>
...
1. Click the `Install Netbird` button.
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/netbird/install_netbird.png" 
...
2. Install Netbird on the Remnawave panel server. Run the command to install Netbird:
    ...
    ![Netbird setup](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/netbird/setup_netbird.png)
...
3. Launch Netbird with the key you copied earlier. Execute the command to connect using the saved key (you will have your own key):
    ...
    ![Netbird setup](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/netbird/setup_netbird2.png)
...
![Netbird peer](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/netbird/peer_netbird.png)
...
![Netbird peer](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/netbird/peer_netbird_node.png)
...
3. In the `Address` field, enter the Netbird IP address of the node (in our case, it's 100.88.74.220; yours may be different).
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/netbird/ip_netbird_node.png" 
        alt="Netbird create setup key" 
        style={{ maxWidth: '75%' }} 
      />
    </div>
...
![Netbird peer](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/netbird/ip_netbird_node1.png)
