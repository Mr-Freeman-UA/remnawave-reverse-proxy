...
1. Select the `WARP Native from distillium` option
    ...
    ![Warp Native Main Menu](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/warp_native.png)

2. Then select the `Install WARP Native` option

    ![Warp Native Install](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/warp_native_main_menu.png)
...
1. Select the `Add WARP-Settings to node configuration` option
    ...
    ![Warp Native Add Config](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/warp_native_add_config.png)

2. Then select which node to add warp-settings configuration

    ![Warp Native Add Node](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/en/warp_native_add_node.png)
