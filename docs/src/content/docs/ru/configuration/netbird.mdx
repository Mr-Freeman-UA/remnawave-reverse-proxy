...
2. Создайте учётную запись
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/ru/netbird/register.png" 
...
5. После этого вы попадёте в панель Netbird.
    ...
    ![Netbird peer](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/ru/netbird/peer.png)
...
1. Переходим в раздел Setup Keys. Нажмите кнопку Create Setup Key.
    ...
    ![Netbird setup key](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/ru/netbird/setup_key.png)

2. Создайте установочный ключ.

    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/ru/netbird/create_new_setup_key.png" 
...
Скопируйте ключ и сохраните его в безопасном месте для дальнейшего использования.
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/ru/netbird/key.png" 
        alt="Netbird key" 
        style={{ maxWidth: '60%' }} 
      />
    </div>
...
1. Нажмите кнопку `Install Netbird`.
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/ru/netbird/install_netbird.png" 
        alt="Netbird create setup key" 
        style={{ maxWidth: '75%' }} 
      />
    </div>
...
2. Установите Netbird на сервере панели Remnawave. Выполните команду для установки Netbird:
    ...
    ![Netbird setup](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/ru/netbird/setup_netbird.png)
...
3. Запустите Netbird с ключом, который вы скопировали ранее. Выполните команду для подключения с использованием сохранённого ключа (у вас будет свой ключ):
    ...
    ![Netbird setup](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/ru/netbird/setup_netbird2.png)
...
![Netbird peer](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/ru/netbird/peer_netbird.png)
...
![Netbird peer](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/ru/netbird/peer_netbird_node.png)
...
3. В поле `Адрес` введите IP-адрес Netbird ноды (в нашем случае это 100.88.74.220, у вас может быть другой).
    ...
    <div style={{ display: 'flex', justifyContent: 'center' }}>
      <img 
        src="https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/ru/netbird/ip_netbird_node.png" 
        alt="Netbird create setup key" 
        style={{ maxWidth: '75%' }} 
      />
    </div>
...
![Netbird peer](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/ru/netbird/ip_netbird_node1.png)
