...
1. Выберите пункт `WARP Native от distillium`
    ...
    ![Warp Native Main Menu](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/ru/warp_native.png)

2. Затем выберите пункт `Установить WARP Native`

    ![Warp Native Install](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/ru/warp_native_main_menu.png)
...
1. Выберите пункт `Добавить WARP-настройки в конфигурацию ноды`
    ...
    ![Warp Native Add Config](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/ru/warp_native_add_config.png)

2. Затем выберите на какую ноду добавить конфигурацию warp-настроек

    ![Warp Native Add Node](https://raw.githubusercontent.com/Mr-Freeman-UA/remnawave-reverse-proxy/refs/heads/main/docs/src/assets/ru/warp_native_add_node.png)
